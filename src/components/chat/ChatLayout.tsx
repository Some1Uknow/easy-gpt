...
interface ChatLayoutProps {
  ...
  type: 'text-to-audio' | 'image-to-text' | 'audio-summary' | 'pdf-summary' | 'text-to-diagram';
}
...
export default function ChatLayout({ children, type }: ChatLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-black">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-72' : 'w-0'} bg-[#111111] transition-all duration-300 overflow-hidden border-r border-[#222222]`}>
